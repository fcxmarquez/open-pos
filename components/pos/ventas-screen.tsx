...
export function VentasScreen() {
  ...
  const handleCancelSale = () => {
    ...
    if (window.confirm("¿Cancelar la venta actual? Se perderan todos los productos del carrito.")) {
      clearCart()
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex flex-1 flex-col overflow-hidden border-r p-5">
        {/* Barcode input */}
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-3 xl:grid-cols-4">
            {frequentProducts.map((product) => (
              <button
                ...
                className="flex flex-col items-start rounded-lg border bg-card p-3 text-left transition-all hover:border-primary/40 hover:shadow-sm active:scale-[0.98]"
              >
      ...
      {/* Right column - Cart */}
      <div className="flex w-[380px] flex-col bg-card xl:w-[420px]">
        {/* Cart header */}
